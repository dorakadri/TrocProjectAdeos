    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="blog-description mt-3">
                ...
                <span class="badge bg-warning my-2 ">{{ $exchange->status }}</span>
            @elseif ($exchange->status === 'accepted')
                <span class="badge bg-success my-2">{{ $exchange->status }}</span>
            @else
                <span class="badge bg-danger my-2">{{ $exchange->status }}</span>
            @endif
