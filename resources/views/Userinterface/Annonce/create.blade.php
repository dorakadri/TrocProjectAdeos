    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            <div class="user-img">
                ...
                <img    src="{{ Auth::user()->profile_photo_url }}" class="avatar-60 rounded-circle"
                alt="{{ Auth::user()->name }}"  loading="lazy">
            </div>
            <div class="post-text ms-3 w-100" data-bs-toggle="modal" data-bs-target="#post-modal">
                ...
                <div class="modal-body">
                    <form action="{{ route('Annonce.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex  gap-5">
                            <div class="user-img">
                                <img  src="{{ Auth::user()->profile_photo_url }}" alt="userimg" class="avatar-40 rounded-circle  img-fluid"
                                    loading="lazy" />
                            </div>
                            <div class="w-100">
                        ...
                        <ul class="d-flex flex-wrap justify-content-between list-inline m-0 p-0">
                            <li class="col-md-12 mb-2">
                                ...
                                <div class="input-group mb-3">
                                    <input type="file" name="imageannonce" class="form-control"
                                        id="inputGroupFile02">
                            ...
                            <li class="col-md-5 mb-3">
                                ...
                                <select class="form-select me-3" name="echangetype" aria-label="Default select example">
                                    ...
                                    <option value="ob_ob" {{ old('echangetype') == 'ob_ob' ? 'selected' : '' }}>Object
                                        against Object</option>
                                    <option value="ob_serv" {{ old('echangetype') == 'ob_serv' ? 'selected' : '' }}>
                                        Object against Service</option>
                                    <option value="donate" {{ old('echangetype') == 'donate' ? 'selected' : '' }}>
                                        Donation</option>
                                </select>
                            ...
                            <li class="col-md-5 mb-3">
                                ...
                                <input type="text" class="form-control rounded ml-3" name="tags"
                                    value="{{ old('tags') }}" placeholder="Example: Wood, Table, etc" />
                                @error('tags')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </li>
