            ...
            <div class="card card-block card-stretch card-height blog blog-detail">
                ...
                <div class="card-body">
                    <div class="image-block">
                        ...
                        <img src="{{ asset('storage/' . $association->logo) }}" class="img-fluid rounded w-100" alt="blog-img"
                            loading="lazy">
                    ...
                    <a href="{{ route('associations.edit1', $association->id) }}"
                        class="btn btn-warning btn-rounded btn-sm my-0">Edit My Association</a>
                    <a href="{{ route('contacts.create') }}" class="btn btn-success btn-rounded btn-sm my-3">Create New
                        Contact</a>
                    <div class="blog-description mt-3">
                        ...
                        <a href="#" class="d-flex align-items-center" tabindex="-1">Read More <i
                                class="material-symbols-outlined md-14">arrow_forward_ios</i></a>
                    </div>
                </div>
